  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="mt-4">
          <div className="text-3xl font-bold transition-all duration-500 group-hover:scale-105 group-hover:translate-x-1 inline-block">24,521</div>
        ...
        <div className="grid grid-cols-3 gap-4 mt-6 text-sm">
          <div className={`p-3 rounded-lg border transition-all duration-300 hover:-translate-y-1 ${
        ...
        >
          <span className="flex items-center">
            View Full Report
            <span className="ml-2 opacity-0 -translate-x-2 transition-all duration-300 group-hover/btn:opacity-100 group-hover/btn:translate-x-0">→</span>
          </span>
        </Button>
      </div>
    </CardBase>
