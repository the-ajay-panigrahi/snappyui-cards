        ...
        <div className="flex justify-between items-center">
          ...
          >
            ...
            <span className="relative">
              Read More
              <span className={`absolute bottom-0 left-0 w-full h-0.5 bg-blue-500 transform scale-x-0 origin-left transition-transform duration-300 ${isHovered ? 'scale-x-100' : ''}`}></span>
            </span>
          </Button>
